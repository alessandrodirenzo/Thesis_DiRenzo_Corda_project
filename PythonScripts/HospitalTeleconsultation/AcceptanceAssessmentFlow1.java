public class AcceptanceAssessmentFlow1{
         ...
         builder.addCommand(new HospitalTeleconsultationContract.Commands.AcceptanceAssessment1(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
