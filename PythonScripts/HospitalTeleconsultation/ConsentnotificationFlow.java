public class ConsentnotificationFlow{

            @InitiatingFlow
            @StartableByRPC
            public static class ConsentnotificationFlowInitiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public ConsentnotificationFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTeleconsultationContract.Commands.Consentnotification(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(ConsentnotificationFlow.ConsentnotificationFlowInitiator.class)
            public static class ConsentnotificationFlowResponder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public ConsentnotificationFlowResponder(FlowSession counterpartySession) {
