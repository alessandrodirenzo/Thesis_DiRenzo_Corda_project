public class ScheduledappointmentFlow{

            @InitiatingFlow
            @StartableByRPC
            public static class ScheduledappointmentFlowInitiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public ScheduledappointmentFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTeleconsultationContract.Commands.Scheduledappointment(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(ScheduledappointmentFlow.ScheduledappointmentFlowInitiator.class)
            public static class ScheduledappointmentFlowResponder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public ScheduledappointmentFlowResponder(FlowSession counterpartySession) {
