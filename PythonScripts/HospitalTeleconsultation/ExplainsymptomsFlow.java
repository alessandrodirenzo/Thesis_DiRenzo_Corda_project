public class ExplainsymptomsFlow{

            @InitiatingFlow
            @StartableByRPC
            public static class ExplainsymptomsFlowInitiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public ExplainsymptomsFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTeleconsultationContract.Commands.Explainsymptoms(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(ExplainsymptomsFlow.ExplainsymptomsFlowInitiator.class)
            public static class ExplainsymptomsFlowResponder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public ExplainsymptomsFlowResponder(FlowSession counterpartySession) {
