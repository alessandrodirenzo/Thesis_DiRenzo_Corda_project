public class RejectionAssessmentFlow1{
         ...
         builder.addCommand(new HospitalTeleconsultationContract.Commands.RejectionAssessment1(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
