public class AllownexttaskFlow{

            @InitiatingFlow
            @StartableByRPC
            public static class AllownexttaskFlowInitiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public AllownexttaskFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTeleconsultationContract.Commands.Allownexttask(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(AllownexttaskFlow.AllownexttaskFlowInitiator.class)
            public static class AllownexttaskFlowResponder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public AllownexttaskFlowResponder(FlowSession counterpartySession) {
