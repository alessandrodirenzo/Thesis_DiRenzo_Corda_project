public class SendfinalreportFlow{

            @InitiatingFlow
            @StartableByRPC
            public static class SendfinalreportFlowInitiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public SendfinalreportFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTelevisitExternalContract.Commands.Sendfinalreport(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(SendfinalreportFlow.SendfinalreportFlowInitiator.class)
            public static class SendfinalreportFlowResponder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public SendfinalreportFlowResponder(FlowSession counterpartySession) {
