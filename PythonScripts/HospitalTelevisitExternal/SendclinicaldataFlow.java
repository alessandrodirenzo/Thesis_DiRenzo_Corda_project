public class SendclinicaldataFlow{

            @InitiatingFlow
            @StartableByRPC
            public static class SendclinicaldataFlowInitiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public SendclinicaldataFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTelevisitExternalContract.Commands.Sendclinicaldata(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(SendclinicaldataFlow.SendclinicaldataFlowInitiator.class)
            public static class SendclinicaldataFlowResponder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public SendclinicaldataFlowResponder(FlowSession counterpartySession) {
