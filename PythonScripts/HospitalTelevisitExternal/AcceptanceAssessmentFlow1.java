public class AcceptanceAssessmentFlow1{

            @InitiatingFlow
            @StartableByRPC
            public static class AcceptanceAssessmentFlow1Initiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public AcceptanceAssessmentFlow1Initiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTelevisitExternalContract.Commands.AcceptanceAssessment1(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(AcceptanceAssessmentFlow1.AcceptanceAssessmentFlow1Initiator.class)
            public static class AcceptanceAssessmentFlow1Responder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public AcceptanceAssessmentFlow1Responder(FlowSession counterpartySession) {
