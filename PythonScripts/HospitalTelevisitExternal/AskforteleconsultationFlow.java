public class AskforteleconsultationFlow{

            @InitiatingFlow
            @StartableByRPC
            public static class AskforteleconsultationFlowInitiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public AskforteleconsultationFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTelevisitExternalContract.Commands.Askforteleconsultation(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(AskforteleconsultationFlow.AskforteleconsultationFlowInitiator.class)
            public static class AskforteleconsultationFlowResponder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public AskforteleconsultationFlowResponder(FlowSession counterpartySession) {
