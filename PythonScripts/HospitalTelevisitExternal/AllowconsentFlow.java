public class AllowconsentFlow{

            @InitiatingFlow
            @StartableByRPC
            public static class AllowconsentFlowInitiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public AllowconsentFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTelevisitExternalContract.Commands.Allowconsent(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(AllowconsentFlow.AllowconsentFlowInitiator.class)
            public static class AllowconsentFlowResponder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public AllowconsentFlowResponder(FlowSession counterpartySession) {
