public class RejectionAssessmentFlow2{

            @InitiatingFlow
            @StartableByRPC
            public static class RejectionAssessmentFlow2Initiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public RejectionAssessmentFlow2Initiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTelevisitExternalContract.Commands.RejectionAssessment2(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(RejectionAssessmentFlow2.RejectionAssessmentFlow2Initiator.class)
            public static class RejectionAssessmentFlow2Responder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public RejectionAssessmentFlow2Responder(FlowSession counterpartySession) {
