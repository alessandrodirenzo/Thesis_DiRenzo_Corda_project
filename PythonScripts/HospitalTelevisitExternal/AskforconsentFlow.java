public class AskforconsentFlow{

            @InitiatingFlow
            @StartableByRPC
            public static class AskforconsentFlowInitiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public AskforconsentFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTelevisitExternalContract.Commands.Askforconsent(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(AskforconsentFlow.AskforconsentFlowInitiator.class)
            public static class AskforconsentFlowResponder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public AskforconsentFlowResponder(FlowSession counterpartySession) {
