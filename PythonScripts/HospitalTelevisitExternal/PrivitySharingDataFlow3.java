public class PrivitySharingDataFlow3{
         ...
         builder.addCommand(new HospitalTelevisitExternalContract.Commands.PrivitySharingData3(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
