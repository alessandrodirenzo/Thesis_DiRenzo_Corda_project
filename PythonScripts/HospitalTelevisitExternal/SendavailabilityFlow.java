public class SendavailabilityFlow{

            @InitiatingFlow
            @StartableByRPC
            public static class SendavailabilityFlowInitiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public SendavailabilityFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new HospitalTelevisitExternalContract.Commands.Sendavailability(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(SendavailabilityFlow.SendavailabilityFlowInitiator.class)
            public static class SendavailabilityFlowResponder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public SendavailabilityFlowResponder(FlowSession counterpartySession) {
