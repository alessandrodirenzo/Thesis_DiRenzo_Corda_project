public class PrivitySharingDataFlow2{
         ...
         builder.addCommand(new BirthCertificateIssueContract.Commands.PrivitySharingData2(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
