public class RequestacceptedFlow{
            ...
            public RequestacceptedFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new AffiliatedVisitContract.Commands.Requestaccepted(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
