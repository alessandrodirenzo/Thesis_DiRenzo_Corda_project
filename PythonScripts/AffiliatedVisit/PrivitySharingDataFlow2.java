public class PrivitySharingDataFlow2{
         ...
         builder.addCommand(new AffiliatedVisitContract.Commands.PrivitySharingData2(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
