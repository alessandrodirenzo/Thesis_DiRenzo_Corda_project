public class NewvisitrequestFlow{

            @InitiatingFlow
            @StartableByRPC
            public static class NewvisitrequestFlowInitiator extends FlowLogic<SignedTransaction> {
            
            private Party initiator;
            private List<Party> receivers;
            
            public NewvisitrequestFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new AffiliatedVisitContract.Commands.Newvisitrequest(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
            ...
            @InitiatedBy(NewvisitrequestFlow.NewvisitrequestFlowInitiator.class)
            public static class NewvisitrequestFlowResponder extends FlowLogic<Void>{
                 
            private FlowSession counterpartySession;
    
            //Constructor
            public NewvisitrequestFlowResponder(FlowSession counterpartySession) {
