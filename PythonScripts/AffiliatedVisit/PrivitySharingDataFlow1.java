public class PrivitySharingDataFlow1{
         ...
         builder.addCommand(new AffiliatedVisitContract.Commands.PrivitySharingData1(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
