public class RecapconventionwithavailabledatesforbookingFlow{
            ...
            public RecapconventionwithavailabledatesforbookingFlowInitiator( List<Party> receivers) {
         ...
         builder.addCommand(new AffiliatedVisitContract.Commands.Recapconventionwithavailabledatesforbooking(), Arrays.asList(this.initiator.getOwningKey(), this.receivers.get(0).getOwningKey()));
