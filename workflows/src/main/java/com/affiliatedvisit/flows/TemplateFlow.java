...
public class TemplateFlow {
    ...
    public static class TemplateFlowInitiator extends FlowLogic<SignedTransaction>{
        ...
        public SignedTransaction call() throws FlowException {
            ...
            final AffiliatedVisit output = new AffiliatedVisit(initiator,receiver);
            ...
            builder.addCommand(new AffiliatedVisitContract.Commands.Send(), Arrays.asList(this.initiator.getOwningKey(),this.receiver.getOwningKey()) );
