...
**In order to check the transaction correctly stored for Citizen registry birth certificate**
 ...
 An example of query vault is represented in [vault image](https://github.com/alessandrodirenzo/Thesis_DiRenzo_Corda_project/blob/main/Diagrams%20images/CorDapp%20screens/Birth_Certificate_Issue_QueryVaults.png).
